...
const Users: React.FC = () => {
    ...
    const buscarCidades = async () => {
      try {
        ...
        if (Array.isArray(cidadesData)) {
          ...
          console.log('✅ Cidades definidas:', cidadesData.length);
        } else {
  ...
  return (
    <PageLayout>
      <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 pt-6 px-4 sm:px-6 lg:px-8">
