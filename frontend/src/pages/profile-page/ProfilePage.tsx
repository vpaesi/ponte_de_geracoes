        ...
        <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 flex items-center justify-center">
          <div className="glass-card p-8">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-semibold text-accent-700">Carregando perfil...</span>
            </div>
          </div>
        </div>
      </PageLayout>
          ...
          <div className="space-y-8">
              ...
              <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 mb-8">
                ...
                <div className="flex-1 text-center lg:text-left">
                  ...
                  <p className="text-lg text-accent-600 mb-4">
                    {userProfile.available ? 'Disponível para ajudar' : 'Indisponível no momento'}
                  </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="glass-card p-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { label: "Data de nascimento", value: new Date(userProfile.birthDate).toLocaleDateString('pt-BR') },
                    { label: "RG", value: userProfile.rg },
                    { label: "CPF", value: userProfile.cpf },
                    { label: "Telefone", value: userProfile.phone },
                    { label: "Email", value: userProfile.email },
                  ].map((item, index) => (
                    <div key={index} className="flex justify-between items-center py-2 border-b border-accent-100 last:border-b-0">
                      <span className="font-medium text-accent-600">{item.label}:</span>
                      <span className="text-accent-800 font-semibold">{item.value}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="glass-card p-6">
                ...
                <div className="space-y-4">
                  {[
                    { label: "Cidade", value: `${userProfile.address.city}/RS` },
                    ...
                    { label: "Complemento", value: userProfile.address.complement || "Não informado" },
                  ].map((item, index) => (
                    <div key={index} className="flex justify-between items-center py-2 border-b border-accent-100 last:border-b-0">
                      <span className="font-medium text-accent-600">{item.label}:</span>
                      <span className="text-accent-800 font-semibold">{item.value}</span>
            ...
            <div className="glass-card p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-accent-700 mb-3">Dias disponíveis:</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-accent-700 mb-3">Status atual:</h4>
                ...
                <div>
                  <h4 className="font-semibold text-accent-700 mb-3">Sobre mim:</h4>
                  <div className="bg-accent-50 rounded-lg p-4">
                    <p className="text-accent-700 leading-relaxed">
                      {userProfile.aboutYou || "Nenhuma informação adicional foi fornecida."}
                    </p>
                  </div>
                </div>
              </div>
