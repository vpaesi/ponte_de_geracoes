...
export const SobreVoceSection: React.FC<SobreVoceSectionProps> = ({
  ...
  return (
    <div className="glass-card p-8">
      <h2 className="text-2xl font-bold text-primary-600 mb-6">Sobre Você</h2>
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <textarea
            ...
            onChange={(e) =>
              atualizarCampo(
                dados.aboutYou !== undefined ? "aboutYou" : "sobreMim",
                e.target.value
              )
            }
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            onChange={(e) => {
              const campo =
                userType === "ajudante"
                  ? dados.skills !== undefined
                    ? "skills"
                    : "habilidades"
                  : dados.needs !== undefined
                  ? "needs"
                  : "necessidades";
