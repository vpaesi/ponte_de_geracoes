...
interface SignupFormStep3SelectUserTypeProps {
  userType: string;
  updateFormData: (field: string, value: string) => void;
}

export const SignupFormStep3SelectUserType: React.FC<
  SignupFormStep3SelectUserTypeProps
        ...
        {userTypes.map((type) => (
          ...
          >
            <div className="text-center">
              <div
                className={`w-16 h-16 mx-auto mb-4 bg-${type.colorClass}-100 rounded-full flex items-center justify-center`}
              >
              ...
              <p className="text-accent-600">{type.description}</p>
              <input
                type="radio"
                name="userType"
                value={type.value}
