...
import BtnCriarConta from "../comuns/BtnCriarConta";
import BtnEncontrarUsuarios from "../comuns/BtnEncontrarUsuarios";
import DescricaoPonteDeGeracoes from "../comuns/DescricaoPonteDeGeracoes";

interface HeroSectionProps {
  userType?: string;
}

export default function SecaoHero({ userType }: HeroSectionProps) {
  return (
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4">
              {userType === "default" ? (
                ...
                <BtnEncontrarUsuarios to="/users" size="lg" />
              )}
            </div>
          </div>
          <img
